...
public class CategoryDetailFacadeREST extends
    AbstractFacade<CategoryDetailEntity> {
  ...
  private CategoryDetailPKEmbeddable getPrimaryKey(PathSegment pathSegment) {
     ...
     * is supposed to be in form of 'somePath;category=categoryValue;attribute=attributeValue'. Here
     ...
     */
    mx.ipn.escom.supernaut.nile.model.CategoryDetailPKEmbeddable key =
        new mx.ipn.escom.supernaut.nile.model.CategoryDetailPKEmbeddable();
  ...
  @Produces({MediaType.APPLICATION_XML + "; charset=UTF-8",
      MediaType.APPLICATION_JSON + "; charset=UTF-8"})
  public List<CategoryDetailEntity> findRange(@PathParam("from") Integer from,
