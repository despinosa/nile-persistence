...
public class ProductDetailFacadeREST extends
    AbstractFacade<ProductDetailEntity> {
  ...
  private ProductDetailPKEmbeddable getPrimaryKey(PathSegment pathSegment) {
     ...
     * is supposed to be in form of 'somePath;product=productValue;attribute=attributeValue'. Here
     ...
     */
    mx.ipn.escom.supernaut.nile.model.ProductDetailPKEmbeddable key =
        new mx.ipn.escom.supernaut.nile.model.ProductDetailPKEmbeddable();
  ...
  @Produces({MediaType.APPLICATION_XML + "; charset=UTF-8",
      MediaType.APPLICATION_JSON + "; charset=UTF-8"})
  public List<ProductDetailEntity> findRange(@PathParam("from") Integer from,
