...
import mx.ipn.escom.supernaut.nile.model.Unit;
import mx.ipn.escom.supernaut.nile.model.UnitPK;
...
public class UnitFacadeREST extends AbstractFacade<Unit> {
    ...
    private UnitPK getPrimaryKey(PathSegment pathSegment) {
        /*
         ...
         */
        mx.ipn.escom.supernaut.nile.model.UnitPK key = new mx.ipn.escom.supernaut.nile.model.UnitPK();
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") PathSegment id, Unit entity) {
        super.edit(entity);
    }
    ...
    public void remove(@PathParam("id") PathSegment id) {
        mx.ipn.escom.supernaut.nile.model.UnitPK key = getPrimaryKey(id);
    ...
    public Unit find(@PathParam("id") PathSegment id) {
        mx.ipn.escom.supernaut.nile.model.UnitPK key = getPrimaryKey(id);
